...
const ChatInterface = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Backend URL from environment variable (set in Vercel dashboard for production)
      ...
      // Backend returns: { status: "ok", data: { answer: "...", sources: [...] } }
      const responseText = data.data?.answer || data.answer || data.response || "No response received";
